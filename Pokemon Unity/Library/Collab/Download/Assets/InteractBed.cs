...
{
    private static string english = "bed";
    private static string spanish = "cama";

    public string engDialog = "No time to sleep in my " + english + ".";
    public string spanDialog = "No time to sleep in my " + spanish + ".";
