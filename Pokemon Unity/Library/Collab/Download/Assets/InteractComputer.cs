...
{
    private static string english = "the computer";
    private static string spanish = "la computadora";

    public string engDialog = "No time to look at memes on " + english + ".";
    public string spanDialog = "No time to look at memes on " + spanish + ".";
