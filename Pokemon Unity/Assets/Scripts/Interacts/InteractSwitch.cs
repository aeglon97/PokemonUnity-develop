...
{
    private static string english = "video games" ;
    private static string spanish = "videojuegos";

    public string engDialog = "My Nintendo Switch! No time for " + english + ".";
    public string spanDialog = "My Nintendo Switch! No time for " + spanish + ".";
