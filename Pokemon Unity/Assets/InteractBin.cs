...
public class InteractBin : MonoBehaviour
{
    private static string english = "the trash";
    private static string spanish = "la basura";

    public string engDialog = "Looks like " + english + " has just been taken out.";
    public string spanDialog = "Looks like " + spanish + " has just been\n taken out.";
