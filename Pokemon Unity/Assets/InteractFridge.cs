...
public class InteractFridge : MonoBehaviour
{
    private static string english = "the fridge";
    private static string spanish = "la nevera";

    public string engDialog = "I'm not hungry now, let's close " + english + ".";
    public string spanDialog = "I'm not hungry now, let's close " + spanish + ".";
