...
{
    private static string english = "the TV";
    private static string spanish = "la televisión";

    public string engDialog = "There's nothing playing on " + english + ".";
    public string spanDialog = "There's nothing playing on " + spanish + ".";
